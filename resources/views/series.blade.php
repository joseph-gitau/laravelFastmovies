<x-app-layout>
    ...
    <div class="container w-full md:w-full lg:w-5/6 h-auto">
        <div class="flex content-center">
            <h1 class="text-xl font-bold text-gray-900 dark:text-white m-auto">Download latest series for free</h1>
        </div>
            ...
            <div class="w-full lg:w-11/12 m-auto flex flex-wrap">
                ...
                @foreach ($users as $key => $data)
                    ...
                    <div class="relative w-52 md:w-52 lg:w-56 group my-4">
                        <img src="/assets/movies/parallels.jpg" alt="{{ $data->s_name }}"
                        ...
                        <span
                            class="absolute top-[15%] left-[18%] text-2xl font-bold text-white hidden group-hover:block duration-500">{{ $data->genre }}</span>
                        <a href="/series/{{ $data->a_id }}-{{ $newname }}">
                            <button
                        ...
                        <h2 class="text-black dark:text-white text-base font-bold ml-6">{{ $data->s_name }}</h2>
                        <span class="text-gray-900 dark:text-white text-sm ml-6">{{ $data->realese_yr }}</span>
