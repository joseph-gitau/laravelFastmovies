<x-app-layout>
        ...
        @foreach ($users as $user)
            ...
            <div class="relative w-48 md:w-52 lg:w-56 group m-auto">
                <img src="https://image.tmdb.org/t/p/w500{{ $user['poster_path'] }}" alt="{{ $user['title'] }}"
                    class="w-44 md:w-48 lg:w-48 h-auto md:h-60 lg:h-64 m-auto border-2 border-black dark:border-white rounded group-hover:opacity-60 group-hover:cursor-pointer duration-300">
                <span
    ...
    <div class="flex w-screen md:w-4/5 lg:w-4/5 flex-wrap m-auto py-6">
        ...
        @foreach ($seriesraw[0] as $serie)
            <div class="relative w-48 md:w-52 lg:w-56 group m-auto">
                <img src="https://fastmovies1.com/seriesImages/{{ $serie->s_img }}" alt="{{ $serie->s_name }}"
                    class="w-44 md:w-48 lg:w-48 h-auto md:h-60 lg:h-64 m-auto border-2 border-black dark:border-white rounded group-hover:opacity-60 group-hover:cursor-pointer duration-300">
                <span
